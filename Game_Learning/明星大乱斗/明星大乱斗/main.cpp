...
Atlas atlas_peashooter_run_left;				// 婉逗射手朝向右的奔跑动画图集
Atlas atlas_peashooter_run_right;				// 婉逗射手朝向右的奔跑动画图集
Atlas atlas_peashooter_attack_ex_left;			// 婉逗射手朝向右的特殊攻击动画图集
Atlas atlas_peashooter_attack_ex_right;         // 婉逗射手朝向右的特殊攻击动画图集
Atlas atlas_peashooter_die_left;				// 婉逗射手朝向右的死亡动画图集
...
Atlas atlas_sunflower_run_left;					// 龙日葵朝向右的奔跑动画图集
Atlas atlas_sunflower_run_right;				// 龙日葵朝向右的奔跑动画图集
Atlas atlas_sunflower_attack_ex_left;			// 龙日葵朝向右的特殊攻击动画图集
Atlas atlas_sunflower_attack_ex_right;			// 龙日葵朝向右的特殊攻击动画图集
Atlas atlas_sunflower_die_left;					// 龙日葵朝向右的死亡动画图集
...
void FlipAtlas(Atlas& src, Atlas& dst) {
	...
	for (int i = 0; i < src.GetSize(); i++) {
		IMAGE img_flipped;
		FlipImage(src.GetImage(i), &img_flipped);
		dst.AddImage(img_flipped);
	}
}
